# Rainfall Prediction in Bangalore
...
**Copyright © 2026 Harsh Singhal. All Rights Reserved.**
...
- Educational, research, and personal use is permitted
- You may view and modify the code for non-commercial purposes
- All copyright notices must be retained

#### 💼 Commercial Use (Requires License)
- Any commercial use requires explicit written permission
- This includes: production deployment, revenue generation, commercial products
- Contact: harshsinghal1972@gmail.com
...
**For commercial licensing inquiries, contact: harshsinghal1972@gmail.com**
